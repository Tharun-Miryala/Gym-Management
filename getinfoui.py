    ...
    def __init__(self):
        def gotinfo():
            ...
            if self.gettininfo.isdigit() == True and len(self.gettininfo) != 0:
                self.Text1.insert(INSERT, " valid id number ""\n")
            else :
                self.Text1.insert(INSERT,"invalid id number""\n")
            ...
            try:
                ...
                while True:
                    ...
                    if self.gettininfo == a:
                        ...
                        if n == 0:
                            print("NO CUSTOMER WITH THIS ID ", self.gettininfo)
                        else:
                            n = 0
                            continue
            except EOFError:
        ...
        self.Label1.place(relx=0.12, rely=0.15, height=48, width=400)
        self.Label1.configure(background="#d9d9d9")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font=font9)
        self.Label1.configure(foreground="#000000")
        self.Label1.configure(text='''ENTER THE ID NUMBER.   :''')
